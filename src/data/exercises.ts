...
export const EXERCISES_DATA: ExerciseData[] = [
  ...
  },
  {
    ...
    variants: [
      { name: 'Fentes alternées', description: 'Un pas en avant jambe droite, retour, puis un pas en avant jambe gauche. Permet de travailler les deux côtés de manière équilibrée dans la même série. Le retour à la position debout entre chaque répétition ajoute un travail de stabilisation.' },
      { name: 'Fentes arrière', description: 'Le pas se fait vers l\'arrière au lieu de vers l\'avant. Plus douce pour les genoux car le poids reste naturellement sur le talon de la jambe d\'appui. Idéale pour les pratiquants ayant des sensibilités au niveau des rotules.' },
      { name: 'Fentes avec pause', description: 'Maintenez la position basse pendant 2 à 3 secondes avant de remonter. La pause élimine l\'élan et augmente le temps sous tension, ce qui intensifie le travail musculaire des quadriceps et des fessiers.' },
      { name: 'Fentes bulgares', description: 'Le pied arrière est surélevé sur une chaise ou un banc. Augmente considérablement la charge sur la jambe avant et l\'étirement du fléchisseur de hanche arrière. Variante exigeante en force et en équilibre, réservée aux pratiquants à l\'aise avec les fentes classiques.' },
      { name: 'Fentes curtsy', description: 'Le pied arrière se croise derrière la jambe d\'appui, comme une révérence. Cible davantage le moyen fessier et les adducteurs, travaillant la stabilité latérale du bassin dans un plan de mouvement rarement sollicité.' },
      { name: 'Fentes latérales', description: 'Le pas se fait sur le côté au lieu de vers l\'avant. Sollicite les adducteurs et les abducteurs en plus des quadriceps et fessiers. Excellent pour la mobilité des hanches et la préparation aux sports impliquant des déplacements latéraux.' },
      { name: 'Fentes marchées', description: 'Enchaînez les fentes en avançant à chaque pas, comme une marche. Le mouvement continu ajoute un défi d\'équilibre dynamique et augmente la composante cardiovasculaire de l\'exercice. Nécessite un espace de quelques mètres.' },
      { name: 'Fentes sautées', description: 'Effectuez un saut pour changer de jambe en position basse. Version plyométrique qui développe l\'explosivité et fait monter le cardio rapidement. Réservée aux pratiquants maîtrisant parfaitement les fentes classiques et n\'ayant aucune douleur articulaire.' },
    ],
    tips: [
  ...
  },
  {
    ...
    variants: [
      { name: 'Glute bridge marché', description: 'En position haute du pont, tendez une jambe devant vous puis reposez-la, et alternez. Cette variante ajoute un travail unilatéral et un défi d\'équilibre qui intensifie l\'activation des fessiers.' },
      { name: 'Hip thrust au sol', description: 'Haut du dos appuyé sur un canapé ou un banc, pieds au sol, soulevez le bassin. L\'amplitude de mouvement est plus grande et la position permet d\'ajouter du poids (sac, haltère) sur les hanches pour progresser en charge.' },
      { name: 'Hip thrust unilatéral', description: 'En position de hip thrust, une seule jambe au sol, l\'autre tendue ou genou ramené vers la poitrine. Double la charge sur la jambe d\'appui et révèle les déséquilibres de force entre les deux côtés.' },
    ],
    tips: [
  ...
  },
  {
    ...
    variants: [
      { name: 'Broad jumps', description: 'Saut en longueur debout vers l\'avant. Développe la puissance horizontale et la capacité d\'extension complète de la chaîne postérieure. Excellent pour le transfert vers les mouvements sportifs.' },
      { name: 'Tuck jumps', description: 'Saut vertical avec les genoux ramenés vers la poitrine en l\'air. Augmente le temps de vol et l\'explosivité. Demande un bon gainage pour contrôler la position en vol.' },
      { name: 'Squat jumps', description: 'Saut explosif vers le haut depuis une position de squat profond, sans support. Combine le travail de force du squat avec l\'explosivité du saut. Très intense pour les quadriceps et les fessiers.' },
    ],
    tips: [
  ...
  },
  {
    ...
    variants: [
      { name: 'Romanian deadlift unilatéral', description: 'Même mouvement de charnière de hanche mais sur une seule jambe, la jambe libre partant en arrière. Augmente considérablement le travail d\'équilibre et la sollicitation des stabilisateurs de hanche.' },
      { name: 'Single leg deadlift', description: 'Similaire au Romanian deadlift unilatéral avec un défi d\'équilibre encore plus marqué. La jambe libre s\'aligne avec le buste pour former une ligne horizontale. Excellent pour corriger les déséquilibres musculaires entre les deux côtés.' },
    ],
    tips: [
  ...
  // ─── Core ───────────────────────────────────────────────────────
  {
    ...
    variants: [
      { name: 'Gainage latéral', description: 'En appui sur un avant-bras et le bord extérieur du pied, corps de profil. Cible les obliques et le moyen fessier pour renforcer la stabilité latérale du tronc. Alternez les deux côtés pour un travail équilibré.' },
      { name: 'Gainage Superman', description: 'En position de planche classique, tendez les bras vers l\'avant comme Superman en vol. Augmente considérablement le bras de levier et la difficulté en sollicitant davantage les érecteurs du rachis et les épaules.' },
      { name: 'Planche épaule', description: 'En position de planche haute (bras tendus), touchez l\'épaule opposée avec chaque main en alternance. Ajoute un défi anti-rotation : le tronc doit résister à la torsion pendant que vous levez une main.' },
      { name: 'Planche RKC', description: 'Planche sur les avant-bras avec une contraction maximale de tout le corps : rapprochez les coudes des pieds (sans bouger), serrez les poings et contractez chaque muscle à fond. Beaucoup plus intense que la planche classique — 10 secondes en RKC valent 30 secondes en planche standard.' },
      { name: 'Bear hold', description: 'À quatre pattes, mains sous les épaules, genoux sous les hanches, soulevez les genoux de 2-3 cm du sol et maintenez. Travaille le gainage dans une position raccourcie qui sollicite intensément les quadriceps et le transverse. Excellent exercice de transition avant la planche.' },
      { name: 'Hollow hold', description: 'Allongé sur le dos, bras tendus au-dessus de la tête et jambes tendues, soulevez les épaules et les pieds du sol en pressant le bas du dos contre le sol. Position de gymnastique qui renforce puissamment le grand droit et le transverse en position allongée.' },
      { name: 'Planche to downward dog', description: 'En position de planche haute, poussez les hanches vers le haut et l\'arrière pour passer en position du chien tête en bas, puis revenez en planche. L\'alternance travaille la mobilité des épaules, la souplesse des ischio-jambiers et le gainage dynamique. Excellent mouvement de transition en échauffement.' },
    ],
    tips: [
  ...
  },
  {
    ...
    variants: [
      { name: 'Bicycle crunchs', description: 'En position de crunch, amenez le coude droit vers le genou gauche pendant que la jambe droite se tend, puis alternez. Le pédalage rotatif sollicite intensément les obliques en plus du grand droit.' },
      { name: 'Sit-ups', description: 'Remontée complète du buste jusqu\'en position assise, le dos décolle entièrement du sol. Mouvement plus complet qui recrute les fléchisseurs de hanche en plus des abdominaux, mais plus exigeant pour le bas du dos.' },
      { name: 'V-ups', description: 'Les jambes et le buste montent simultanément pour former un V, les mains cherchent à toucher les pieds. Variante avancée qui demande force abdominale et souplesse des ischio-jambiers.' },
      { name: 'Russian twists', description: 'Assis en équilibre sur les fessiers, pieds décollés du sol, effectuez des rotations du buste de gauche à droite. Cible les obliques et le transverse avec un travail d\'antirotation dynamique.' },
      { name: 'Toe touches', description: 'Allongé sur le dos, jambes tendues à la verticale, montez les mains pour toucher les orteils. Le mouvement court et ciblé isole la partie haute du grand droit avec une contraction intense.' },
    ],
    tips: [
  ...
  },
  {
    ...
    variants: [
      { name: 'Superman alterné', description: 'Soulevez le bras droit et la jambe gauche simultanément, puis alternez. Réduit la difficulté et ajoute un travail de stabilisation anti-rotation du bassin.' },
      { name: 'Back extensions', description: 'Seul le haut du corps se soulève, les jambes restent au sol. Concentre le travail sur les érecteurs du rachis et le haut du dos, idéal pour les débutants ou en pré-fatigue.' },
      { name: 'Reverse hyper sur table', description: 'Allongé sur le ventre au bord d\'une table, hanches en appui, soulevez les jambes vers l\'horizontal. Cible les fessiers et les lombaires avec une amplitude accrue et sans compression discale.' },
      { name: 'Reverse snow angels', description: 'En position de superman maintenue, effectuez un arc de cercle avec les bras, du devant vers les hanches et retour. Le mouvement continu sous tension brûle les rhomboïdes et les trapèzes.' },
      { name: 'Prone T raises', description: 'Face au sol, bras écartés sur les côtés, soulevez-les pour former un T. Cible spécifiquement les trapèzes moyens et les rhomboïdes, parfait pour corriger les épaules enroulées.' },
      { name: 'Prone Y raises', description: 'Face au sol, bras tendus vers l\'avant à 45 degrés, soulevez-les pour former un Y. Recrute les trapèzes inférieurs et les deltoïdes postérieurs, renforçant la stabilité de l\'omoplate.' },
    ],
    tips: [
  ...
  },
  {
    ...
    variants: [
      { name: 'Flutter kicks', description: 'Jambes tendues à quelques centimètres du sol, effectuez de petits battements alternés rapides. Le maintien continu sous tension avec le bas du dos plaqué au sol brûle les abdominaux et les fléchisseurs de hanche.' },
      { name: 'Scissors', description: 'Jambes tendues décollées du sol, croisez-les en alternance comme des ciseaux. Le mouvement de croisement ajoute une composante d\'adduction et un travail des obliques à l\'effort de maintien abdominal.' },
    ],
    tips: [
  ...
  },
  {
    ...
    variants: [
      { name: 'Star jumps', description: 'Saut explosif où bras et jambes s\'écartent au maximum en l\'air pour former une étoile. Plus intense que le jumping jack classique, cette variante développe la puissance et sollicite davantage les fessiers et les épaules.' },
    ],
    tips: [
  ...
  },
  {
    ...
    variants: [
      { name: 'Talon-fesses', description: 'Au lieu de monter les genoux, les talons viennent frapper les fessiers en arrière. Cible davantage les ischio-jambiers et les mollets tout en réduisant le stress sur les fléchisseurs de hanche.' },
    ],
    tips: [
  ...
  },
  {
    ...
    variants: [
      { name: 'Lateral bounds', description: 'Sauts latéraux plus amples et plus explosifs, avec un temps de vol plus long. Développe davantage la puissance et l\'explosivité des membres inférieurs. Nécessite une bonne stabilité de cheville.' },
      { name: 'Pas chassés', description: 'Déplacement latéral en pas glissés sans phase de vol. Réduit l\'impact articulaire tout en travaillant les adducteurs et la coordination latérale. Idéal pour l\'échauffement ou les débutants.' },
    ],
    tips: [
  ...
  // ─── Full body ──────────────────────────────────────────────────
  {
    ...
    variants: [
      { name: 'Burpees sans pompe', description: 'On saute en planche et on revient sans effectuer la pompe. Réduit la difficulté tout en gardant l\'effet cardio. Bon point de départ pour construire l\'endurance.' },
      { name: 'Burpees sans saut', description: 'On remplace le saut final par une simple extension debout. Moins d\'impact sur les articulations, idéal en appartement ou pour les pratiquants avec des sensibilités aux genoux.' },
      { name: 'Burpees avec tuck jump', description: 'Le saut final est remplacé par un saut genoux poitrine. Version avancée qui augmente l\'explosivité et la demande cardiovasculaire.' },
    ],
    tips: [
  ...
  // ─── Mobilité & Échauffement ───────────────────────────────────
  {
    ...
    variants: [
      { name: 'Étirement ischio-jambiers', description: 'Jambe tendue posée devant vous sur un support bas ou au sol, penchez le buste en avant en gardant le dos droit jusqu\'à sentir l\'étirement à l\'arrière de la cuisse. Maintenez 20 à 30 secondes de chaque côté.' },
      { name: 'Étirement pectoraux', description: 'Bras tendu contre un mur ou un encadrement de porte à 90°, pivotez lentement le buste vers l\'extérieur jusqu\'à sentir l\'étirement dans la poitrine et l\'avant de l\'épaule. Maintenez 20 à 30 secondes de chaque côté.' },
      { name: 'Étirement psoas', description: 'En position de fente basse, genou arrière au sol, poussez les hanches vers l\'avant jusqu\'à sentir l\'étirement à l\'avant de la hanche arrière. Le buste reste droit. Maintenez 20 à 30 secondes de chaque côté.' },
      { name: 'Étirement quadriceps debout', description: 'Debout sur une jambe, attrapez le pied de l\'autre jambe derrière vous et tirez le talon vers la fesse en gardant les genoux serrés. Gardez le bassin neutre. Maintenez 20 à 30 secondes de chaque côté.' },
      { name: 'Étirement triceps', description: 'Bras levé, pliez le coude pour amener la main derrière la tête entre les omoplates. Avec l\'autre main, poussez doucement le coude vers le bas. Maintenez 20 à 30 secondes de chaque côté.' },
    ],
    tips: [
  ...
  },
  {
    ...
    variants: [
      { name: 'Cat-cow', description: 'À quatre pattes, alternez lentement entre dos rond (chat : tête baissée, nombril rentré, dos vers le plafond) et dos creux (vache : tête levée, ventre vers le sol, poitrine ouverte). Mobilise toute la colonne vertébrale segment par segment.' },
      { name: 'Child\'s pose', description: 'À genoux, asseyez-vous sur les talons et tendez les bras devant vous, front au sol. Respirez profondément dans le bas du dos. Position de repos et d\'étirement qui relâche les lombaires, les épaules et les hanches.' },
      { name: 'Deep squat hold', description: 'Maintenez un squat profond (fesses près du sol), pieds à plat, coudes contre l\'intérieur des genoux pour les pousser vers l\'extérieur. Améliore la mobilité des hanches, des chevilles et du bas du dos. Maintenez 30 à 60 secondes.' },
      { name: 'Hip 90/90', description: 'Assis au sol, une jambe pliée à 90° devant vous (rotation externe de hanche) et l\'autre à 90° sur le côté (rotation interne). Pivotez pour alterner les côtés. Travaille la mobilité en rotation des hanches dans les deux directions.' },
      { name: 'Pigeon stretch', description: 'En position de fente, amenez le tibia avant au sol devant vous (parallèle ou en diagonale) et allongez la jambe arrière. Penchez le buste vers l\'avant pour intensifier l\'étirement du fessier et du piriforme. Maintenez 30 secondes de chaque côté.' },
      { name: 'Scorpion stretch', description: 'Allongé sur le ventre, bras écartés en croix. Amenez le pied droit vers la main gauche en tournant le bassin, puis alternez. Mobilise la colonne thoracique en rotation et étire les fléchisseurs de hanche.' },
      { name: 'World\'s greatest stretch', description: 'En position de fente basse, posez la main intérieure au sol, puis effectuez une rotation du buste en levant l\'autre bras vers le ciel. Combine fente, rotation thoracique et ouverture de hanche en un seul mouvement complet. Le roi des échauffements.' },
    ],
    tips: [
  ...
  },
  {
    ...
    variants: [
      { name: 'Rotations articulaires', description: 'Effectuez des cercles lents et contrôlés avec chaque articulation : cou, épaules, coudes, poignets, hanches, genoux et chevilles. Commencez petit et agrandissez progressivement les cercles. 10 rotations dans chaque sens par articulation.' },
      { name: 'Marche rapide sur place', description: 'Marchez vigoureusement sur place en levant les genoux et en balançant les bras de manière coordonnée. Augmente progressivement la fréquence cardiaque sans impact. Parfait pour commencer l\'échauffement avant des mouvements plus intenses.' },
      { name: 'Toe taps (marche)', description: 'Face à une marche ou un step bas, tapez alternativement la pointe de chaque pied sur le bord. Le rythme est rapide et régulier, comme un petit pas de course. Travaille la coordination, l\'agilité et échauffe les mollets et les fléchisseurs de hanche.' },
      { name: 'Respiration profonde', description: 'Inspirez lentement par le nez pendant 4 secondes en gonflant le ventre, retenez 4 secondes, puis expirez par la bouche pendant 6 secondes. Utilisé en fin de séance pour ramener le système nerveux au calme et accélérer la récupération. 5 à 10 cycles suffisent.' },
    ],
    tips: [
