  ...
  return (
    <div className="max-w-4xl mx-auto px-6 md:px-10 py-10 md:py-16">
      ...
      <div className="text-center mb-10">
        <h1 className="font-display text-3xl md:text-4xl font-black text-heading mb-3">
          Choisis ton plan
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
        ...
        <div className="rounded-2xl border border-card-border bg-surface-card p-6 flex flex-col">
          <h2 className="font-display text-lg font-bold text-heading mb-1">Gratuit</h2>
        ...
        <div className="rounded-2xl border-2 border-accent bg-surface-card p-6 flex flex-col relative">
          ...
          <div className="flex items-center gap-2 mb-1">
            ...
            <h2 className="font-display text-lg font-bold text-heading">Premium</h2>
          </div>
